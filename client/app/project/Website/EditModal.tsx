  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
      ...
      >
        ...
        <div
          className="flex flex-col gap-4 overflow-y-auto minimal-scrollbar"
          style={{
            maxHeight: "80%",
          }}
        >
            ...
            <div className="w-full flex flex-col gap-4">
              <div className="w-full">
                ...
                <div className="flex gap-1">
                  <button
                    className={`px-2 w-8 py-1 rounded border text-sm ${
                    ...
                    onClick={() => {
                      if (selectedElement) {
                        selectedElement.element.style.flexDirection = "column";
                        setComputedStyles({
                          ...computedStyles,
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (selectedElement) {
                        selectedElement.element.style.flexDirection = "row";
                        setComputedStyles({
                          ...computedStyles,
                          flexDirection: "row",
                        });
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`px-2 py-1 rounded border text-xs ${
                        computedStyles.justifyContent === justify
                          ? "bg-zinc-600 text-white border-zinc-500"
                          : darkMode
                          ? "bg-zinc-800 text-white border-zinc-700"
                          : "bg-white text-zinc-900 border-zinc-300"
                      ...
                      onClick={() => {
                        if (selectedElement) {
                          selectedElement.element.style.justifyContent =
                            justify;
                          setComputedStyles({
                            ...computedStyles,
                ...
                <div className="flex gap-1">
                  {[
                    ...
                    <button
                      key={align}
                      className={`px-2 py-1 rounded border text-xs ${
                        computedStyles.alignItems === align
                          ? "bg-zinc-600 text-white border-zinc-500"
                          : darkMode
                          ? "bg-zinc-800 text-white border-zinc-700"
                          : "bg-white text-zinc-900 border-zinc-300"
                      ...
                      onClick={() => {
                        if (selectedElement) {
                          selectedElement.element.style.alignItems = align;
                          setComputedStyles({
                            ...computedStyles,
                            alignItems: align,
                          });
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (selectedElement) {
                        const isSelected =
                          computedStyles.textDecoration === decoration;
                        selectedElement.element.style.textDecoration =
